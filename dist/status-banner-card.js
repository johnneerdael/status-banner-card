...
`;let Rt=class extends at{setConfig(t){if(!t.entity)throw new Error("You need to define an entity");this._config={...$t,...t,color_map:{...$t.color_map,...t.color_map}}}getCardSize(){return"compact"===this._config?.variant||"header-only"===this._config?.variant?2:3}shouldUpdate(t){if(t.has("_config"))return!0;if(t.has("hass")){const e=t.get("hass");if(!e)return!0;const i=this._config.entity;return e.states[i]!==this.hass.states[i]||(!(!this._config.timestamp_entity||e.states[this._config.timestamp_entity]===this.hass.states[this._config.timestamp_entity])||!(!this._config.secondary_info_entity||e.states[this._config.secondary_info_entity]===this.hass.states[this._config.secondary_info_entity]))}return!0}static getConfigElement(){return document.createElement("status-banner-card-editor")}static getStubConfig(){return{entity:"",rules:[{state:"on",title:"Active",subtitle:"System is running",icon:"mdi:check-circle",color:"#4CAF50"},{state:"off",title:"Inactive",subtitle:"System is idle",icon:"mdi:power-standby",color:"#9E9E9E"}],default:{title:"{{ state | upper }}",subtitle:"",icon:"mdi:information",color:"#2196F3"}}}render(){if(!this._config||!this.hass)return I``;const t=St(this.hass,this._config.entity,this._config.rules,this._config.default,this._config.color_map),e=this._config.variant||"full",i=!1!==this._config.show_status&&"header-only"!==e,s=!1!==this._config.show_footer&&"header-only"!==e;return I`
    ...
    `}_renderHeader(t){const e=!1!==this._config.show_pattern;return I`
    ...
    `}_renderStatusBox(t){return I`
      <div class="body">
        <div class="status-box">
          <span class="status-label" style="color: ${t.color}">Status:</span>
    ...
    `:I``}_renderButton(t,e){const i=this.hass.states[this._config.entity],s={hass:this.hass,entity:this._config.entity,state:i?.state||"",attr:i?.attributes||{},colorMap:this._config.color_map},o=t.label?gt(t.label,s):"Update";return I`
      <button
    ...
    `}};t([ut({attribute:!1})],Mt.prototype,"hass",void 0),t([pt()],Mt.prototype,"_config",void 0),t([pt()],Mt.prototype,"_expandedRule",void 0),Mt=t([lt("status-banner-card-editor")],Mt);export{Rt as StatusBannerCard,Mt as StatusBannerCardEditor};
